...
import datasets.diabetes.diabetes_with_race as diabetes_r
import datasets.diabetes.diabetes_with_sex as diabetes_s
...
if __name__ == '__main__':
	...
	di_path     = f'results/iclr_diabetes_{mode}_ds_rl_di_0/iclr_diabetes_{mode}_ds_rl_di.h5'
	dp_path     = f'results/iclr_diabetes_{mode}_ds_rl_dp_0/iclr_diabetes_{mode}_ds_rl_dp.h5'
	...
	n_total = diabetes.load(gpa_cutoff=3.0).training_splits()['X'].shape[0]
